                ...
                <div className="row pt-5">
                    ...
                    <nav className="main-nav1">
                        ...
                        <div
                            ...
                            <ul>
                                <li>
                                    <Link activeClass='' smooth spy to="ruloans">EMI</Link>
                                </li>
                                <li>
                                    <Link smooth spy to="">Overview</Link>
                                </li>
                                <li>
                                ...
                                <li>
                                    <Link smooth spy to="boomer">Fees & Charges</Link>
                                </li>
                                <li>
                    ...
                    <div className="col-10 mx-auto">
                        ...
                        <div className='row'>
                            ...
                            <div className='col order-1'>
                                <h2 className='setcolor'>GOLD LOAN</h2>
                                <div className='col'>
